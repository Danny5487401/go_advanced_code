...
func main() {
	...
	certOut, err := os.Create("chapter12_net/09_https/ca_pem/cert.pem")
	if err != nil {
	...
	keyOut, err := os.OpenFile("chapter12_net/09_https/ca_pem/key.pem", os.O_WRONLY|os.O_CREATE|os.O_TRUNC, 0600)
	if err != nil {
